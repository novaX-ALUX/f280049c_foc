// am_4116_kvb.h —— NovaX/AM-4116 (KV 版本 B, 与 A 不同 KV) FOC profile
...
#define MOTOR_KV_RPM_PER_V                (0)        // [输入] TODO: 填 KV 版本 B 的实际 KV(与 A 不同)

#define USER_MOTOR_TYPE                   MOTOR_TYPE_PM
#define USER_MOTOR_NUM_POLE_PAIRS         (7)        // [输入] 4116 = 12N14P -> 7 极对(几何; 上电复核)
