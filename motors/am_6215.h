...
// (Parameters from earlier projects are unreliable; use is05 measured values exclusively.) See motors/README.md.
#ifndef MOTOR_AM_6215_H
#define MOTOR_AM_6215_H

#define MOTOR_NAME                        "AM-6215"
#define MOTOR_KV_RPM_PER_V                (0)        // [Input] TODO: fill in the actual KV

#define USER_MOTOR_TYPE                   MOTOR_TYPE_PM
#define USER_MOTOR_NUM_POLE_PAIRS         (14)       // [Input] 6215 = 14 pole pairs (geometric; verify at power-on)
...
#define USER_MOTOR_Ls_d_H                 (15.0e-6)   // seed; overwritten by is05
#define USER_MOTOR_Ls_q_H                 (15.0e-6)   // seed; overwritten by is05
#define USER_MOTOR_RATED_FLUX_VpHz        (0.012)     // seed; overwritten by is05
